...
def create_app():
    ...
    def add_header(response):
        csp = (
            "default-src 'self'; "
            "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://*.jsdelivr.net https://*.googleapis.com https://apis.google.com https://*.cdnjs.cloudflare.com https://unpkg.com https://*.gstatic.com https://www.gstatic.com; "
